...
export default function App() {
  ...
  const [activeCategory, setActiveCategory] = useState<'all' | 'media' | 'text' | 'utility'>('all');
      ...
      {activeToolId === null ? (
        <>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 my-6">
            <div className="relative rounded-2xl overflow-hidden border border-dashed border-slate-300 dark:border-slate-800 bg-slate-100/30 dark:bg-slate-900/30 py-4 px-4 text-center min-h-[90px] sm:min-h-[100px] flex flex-col items-center justify-center transition-all">
